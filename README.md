...
![image](https://github.com/JuFnd/highload-hw-slack/assets/109366718/d679dacd-fd87-4b55-8b03-7a0dbd7059e5)
  ...
  #### Table Messages: 
  Эта таблица хранит информацию о сообщениях. Каждое сообщение имеет уникальный идентификатор (id), идентификатор отправителя (sender_id), временную метку (timestamp), содержание (content), идентификатор файла сообщения (message_file_id), и реакцию в виде эмодзи (reaction_emoji).
