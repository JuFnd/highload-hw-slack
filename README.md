...
![изображение](https://github.com/JuFnd/highload-hw-slack/assets/109366718/b0a8e4ff-326d-44a9-8e8a-4050ef44b535)
...
### Резервирование:
Master-Standby репликация для Postgresql, Cassandra в сервисах Channel и Chat

### Отказоустойчивость:
Отказоустойчивость реализуем по принципу graceful shutdown.
...
Чтобы настроить логирование в Envoy, необходимо добавить конфигурацию в секцию admin в файл конфигурации Envoy.
